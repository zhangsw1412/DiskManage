...
-- ----------------------------
--  Table structure for `tb_boxreadhistory`
-- ----------------------------
DROP TABLE IF EXISTS `tb_boxreadhistory`;
CREATE TABLE `tb_boxreadhistory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `columnNum` int(11) NOT NULL COMMENT '柱号',
  `layerNum` int(11) NOT NULL COMMENT '大层号',
  `loadTime` int(11) NOT NULL COMMENT '读取时间',
  `rackId` int(11) NOT NULL COMMENT '机架号',
  `rowNum` int(11) NOT NULL COMMENT '小层号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='光盘读取历史记录';

-- ----------------------------
--  Records of `tb_boxreadhistory`
-- ----------------------------
BEGIN;
INSERT INTO `tb_boxreadhistory` VALUES ('1', '1', '1', '1469083825', '1', '1'), ('2', '1', '2', '1469083846', '1', '2'), ('3', '2', '2', '1469083852', '2', '2'), ('4', '2', '2', '1469083864', '2', '5'), ('5', '2', '2', '1469083870', '2', '4'), ('6', '2', '4', '1469083888', '2', '4'), ('7', '2', '3', '1469083892', '2', '4'), ('8', '2', '3', '1469083897', '2', '7'), ('9', '2', '3', '1469083902', '1', '7'), ('10', '5', '3', '1469083907', '1', '7'), ('11', '4', '3', '1469083912', '1', '7'), ('12', '4', '7', '1469083929', '1', '7'), ('13', '4', '7', '1469083936', '1', '3'), ('14', '3', '7', '1469083943', '1', '3'), ('15', '3', '7', '1469083949', '1', '9');
COMMIT;
...
CREATE TABLE `tb_cdmodel` (
  ...
  `rackId` int(11) NOT NULL,
  `rowNum` int(11) NOT NULL,
  `burnBeginTime` int(11) NOT NULL,
  `burnEndTime` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_cdmodel` VALUES ('1', '0', '7', '1', '3', '0', '2', '1469089464', '1469089480'), ('2', '1', '7', '1', '3', '0', '2', '1469089464', '1469089480'), ('3', '0', '0', '1', '3', '0', '3', '1469089464', '1469089480'), ('4', '1', '0', '1', '3', '0', '3', '1469089464', '1469089480'), ('5', '3', '0', '0', '3', '0', '2', '1469089464', '1469089480'), ('6', '2', '7', '0', '3', '0', '2', '1469089464', '1469089480');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_init_params` VALUES ('4', '5', '1', '1024', '1024', '/', '/', '/', '/', '/');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_rack_params` VALUES ('2', '3', '2', '3', '2', '64', '1024');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` VALUES ('1', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '1469090467', '127.0.0.1', '1');
COMMIT;
